...
public interface IVeiculoRepository
{
    ...
    Task<IEnumerable<Veiculo>> GetByFiltrosAsync(string? marca = null, string? modelo = null, int? anoMin = null, int? anoMax = null, decimal? precoMin = null, decimal? precoMax = null);
}